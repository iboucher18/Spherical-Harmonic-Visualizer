...
def main():
    ...
    # RunCalculator_Windows(input_data) # Does not build calculator for you - for testing purposes only
    ...
    if input_data.do_fourier:
        fourier_sphere_data_filepath_real = os.path.join(input_data.output_path, 'SphereData_postFourierTransform_real.csv')
        calculator_results_fourier_real = pd.read_csv(fourier_sphere_data_filepath_real)
        fourier_sphere_data_filepath_imag = os.path.join(input_data.output_path, 'SphereData_postFourierTransform_imag.csv')
